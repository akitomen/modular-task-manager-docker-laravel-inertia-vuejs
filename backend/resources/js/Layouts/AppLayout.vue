                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <a class="inline-flex items-center px-1 pt-1 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition" href="taskmanager">Task Manager</a>
                            </div>
                        </div>
=
